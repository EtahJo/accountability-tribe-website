...
const Navbar = () => {
  ...
  return (
    <div className="bg-purple p-2 rounded-full flex justify-between align-middle items-center">
      <div className="bg-white rounded-full px-4 py-2 shadow-3xl">
      ...
      {login ? (
        ...
        <div className="flex gap-2 items-center">
          ...
          <p className="text-white text-lg bg-black rounded-full p-2 shadow-3xl shadow-white">
            Sign Up
          </p>
        </div>
      )}
